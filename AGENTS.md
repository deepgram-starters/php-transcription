...
PHP demo app for Deepgram Transcription.
...
| File | Purpose |
|------|---------|
| `server.php` | Main backend — API endpoints and request handlers |
...
```
feat(php-transcription): add diarization support
fix(php-transcription): resolve WebSocket close handling
refactor(php-transcription): simplify session endpoint
